...
class User extends Validate
{
    protected $rule = [
        ...
        'confirm_password'  => 'require|eq:password'
    ];
    protected $message  = [
    ...
    protected function isRegister($value, $rule)
    {
    ...
    protected function phoneIsResgister($value, $rule)
    {
